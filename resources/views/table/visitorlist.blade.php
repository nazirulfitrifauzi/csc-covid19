        ...
        <div>
          <div id='recipients' class="pl-8 pr-8 pb-8  pt-3 lg:mt-0 rounded shadow bg-white">
           <div class="bg-indigo-900 rounded flex justify-between mb-4 ">
		         ...
		         rounded-md mb-4" >List of Visitor </p>
            ...
            <table id="dataTable1" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
              <thead>
                <tr>
                  <th>Name</th>
                  <th>Designation</th>
              ...
              <tbody>
                @foreach($visitor as $visitorlist)
                <tr>
              
                  <td>{{$visitorlist->name}}</td>
                  <td>{{$visitorlist->designation}}</td>
                  <td>{{$visitorlist->company}}</td>
                  <td>{{$visitorlist->visitingwho}}</td>
                 <td>
                  	<a class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-1 px-2 rounded-full text-sm" 
                      href="{{url('VisitoreQuestList/'.$visitorlist->id.'')}}">

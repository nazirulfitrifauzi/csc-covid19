	...
	<form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" action="{{ url('TempCheck')}}">
		...
		<div class="mb-6">
			<div class="flex">
				...
				<img class="w-5 h-6 sm:h-8 pb-2"  src="https://img.icons8.com/doodle/48/000000/temperature.png"/>
			</div>
			<input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" type="number" step="0.01" name="temperature" required>
		</div>
